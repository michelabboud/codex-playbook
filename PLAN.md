...
- [x] `checkpoint/0.1.6` tagged and pushed after Claude's
  `checkpoint/0.1.16` at `97938d0`. Codex remote `main` and the peeled tag
  both resolved to `a5d41bc` after push — 2026-09-23.
